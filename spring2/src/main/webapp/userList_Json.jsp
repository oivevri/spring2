	...
	function userInsert(){
		...
		$('#btnInsert').on('click',function(){
			$.ajax({ 
			    ...
			    // 제이슨구조로 안보낼거라면 데이터도 data : $("#form1").serialize() 쓰고, 컨트롤러에서 @ 필요없이 그냥 UserVO vo 쓰면 됨
			    
			    data : JSON.stringify($("#form1").serializeObject()),
			    contentType: 'application/json',  // 이게 중요.. 제이슨구조로 보냈다면 반드시 컨트롤러(서버)에서는 @RequestBody가 들어가야함
